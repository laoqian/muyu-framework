...
let colModel = [
    ...
    {label: '密码', name: 'password', width: 150,editable:true,editrules:{required:true},hidden:true, edittype:'password'},
    {label: '重复密码', name: 'passWord1', width: 150,editable:true,editrules:{required:true},hidden:true, edittype:'password'},
